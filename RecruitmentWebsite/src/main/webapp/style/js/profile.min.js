	...
	window.onbeforeunload = function() {
		...
		submitHandler: function(a) {
			...
			var b = $('input[name="name"]', a).val(),
				...
				j = $("#resumeId").val(),
				l = $("#resubmitToken").val();
			$(a).find(":submit").val("保存").attr("", !0), $.ajax({
				url: "doUpdateResumename.controller",
				type: "POST",
				data: {
					name: b,
					sex: c,
		...
		var b = $(this).parents("#resumeSet"),
			c = b.children(".defaultResume").val(); - 1 == c ? (b.children(".noSet").show(), b.children(".set0").hide(), b.children(".set1").hide(), b.children("#resumeSetForm").addClass("dn")) : (b.children(".noSet").hide(), b.children(".set" + c).show(), b.children("#resumeSetForm").addClass("dn")), a = !0
