...
public interface AdminuserMapper {
	...
	// value(null,#{adminuser.ausername},#{adminuser.apassword},#{adminuser.apicture},#{adminuser.astatus},NOW()")
	...
	// ausername=#{adminuser.ausername},apassword=#{adminuser.apassword},apicture=#{adminuser.apicture},astatus=#{adminuser.astatus},adatatime=NOW()
	// where aid=#{adminuser.aid}")
	...
	@Update("UPDATE occupation SET ostate=1 WHERE oid=#{oid}")
